...
using NCaro.DependencyInjection.Builder;
using Xunit;

namespace NCaro.DependencyInjection.Scope
{
...
//        }
        ...
        [ServiceImplementation(typeof(ScopedService), scope:DependencyInjection.Attributes.Scope.Scoped, component:"scoped")]
        class ScopedService
        {
